...
import com.lbs.tedam.selenium.exception.DoubleClickOperationException;
...
public class DoubleClickOperation extends Operation {
	...
	public DoubleClickOperation(OperationParam operationParam) {
	...
	public OperationResult doOperation() throws OperationException {
		...
		try {
			Actions doubleClickAction = new Actions(getOperationParam().getDriver());
			...
			throw new DoubleClickOperationException(getOperationParam());
		}
	}
